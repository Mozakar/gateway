...
<head>
	...
	<title>انتقال به درگاه پاسارگاد </title>
	<style type="text/css">
...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <h1 class="content-head">{!! $resNum !!}</h1>
            <h2>درحال انتقال به درگاه بانک پاسارگاد...</h2>
            <div class="l-box-lrg is-center pure-u-1 pure-u-md-1-2 pure-u-lg-2-5">

            </div>

            <form id="bankForm" method="POST" action="{!! $gateUrl !!}">
