...
namespace Mozakar\Gateway\Samanold;
...
class SamanOld extends PortAbstract implements PortInterface
{
    /**
     *
    ...
    protected function userPayment()
    {
        ...
        $this->newLog($payRequestResCode, @SamanOldException::$errors[$payRequestRes]);
        throw new SamanOldException($payRequestRes);
    }
    ...
    protected function verifyPayment()
    {
        ...
        $this->transactionFailed();
        $this->newLog($response, SamanOldException::$errors[$response]);
        throw new SamanOldException($response);
